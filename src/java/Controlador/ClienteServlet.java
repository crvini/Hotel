...
public class ClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int telefono= Integer.parseInt(request.getParameter("telefono_cliente"));
            Cliente c = new Cliente();
            c.insertar_nuevo_cliente(nit, nombre, direccion, telefono);
            String direccionPagina="http://localhost:8080/Hotel/cncliente.jsp";//aqui se debe cambiar la direccion para redireccionar
